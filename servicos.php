...
<body>
    ...
    <section>
        ...
        <div class="service-item">
            <h2>Limpeza De Jardins</h2>
            <ul>
                <li>Remoção de folhas e detritos;</li>
                <li>Limpeza de canteiros e bordas;</li>
                <li>Varrimento e limpeza de pátios e calçadas adjacentes ao jardim.</li>
            </ul>
        </div>
    </section>
    <footer class="footer">
