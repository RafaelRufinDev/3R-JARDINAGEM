...
<body>
    ...
    <section class="about-story-mission">
        <div class="story-text">
            ...
            <p>A 3R JARDINAGEM começou quando Borges ingressou na empresa onde atualmente trabalha,
                ...
                ainda
                trabalha na empresa a qual iniciou sua jornada no mundo do trabalho, e concilia o seu tempo entre
                emprego
    ...
    <section class="about-values">
        ...
        <div class="value-itens">
            ...
            <p>Buscamos sempre a excelência e a qualidade em nossos serviços, garantindo a satisfação de nossos
                clientes.
            </p>
        </div>
        </div>
    ...
    <section class="about-cta">
        ...
        <a href="formulario.php" class="cta-button">Fale conosco e Solicite um Orçamento!</a>
    </section>
